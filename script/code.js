...
let head = document.querySelector('[data-mainHeading]')
head.innerText = "Javascript is my breakfast for today";


// 2. DO NOT USE QUERY SELECTOR: change the first subheading to 'Javascript is awesome and cool'
// let firstSubheading = document.getElementsByTagName(h4)[0]
...
document.querySelectorAll('[data-textset]').forEach(a=> 
    {
        a.addEventListener('click',()=> alert(a.getAttribute ("[data-textset]")))
    })    
